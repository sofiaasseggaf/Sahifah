...
public class AdapterSurahLatin extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<ModelQuran> dataItemList;
    private Context context;

    public AdapterSurahLatin(List<ModelQuran> dataItemList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.v_surah_tanpaindo, parent, false);
