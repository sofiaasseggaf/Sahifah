...
public class ZiarahContentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /*btn_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(ZiarahContentActivity.this, HomeActivity.class);
                startActivity(a);
                finish();
            }
        });
        ...
        btn_hikmah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(ZiarahContentActivity.this, HikmahActivity.class);
                startActivity(a);
                finish();
            }
        });
        ...
        btn_oase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(ZiarahContentActivity.this, OaseActivity.class);
                startActivity(a);
                finish();
            }
        });
        ...
        btn_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(ZiarahContentActivity.this, ProfileActivity.class);
                startActivity(a);
                finish();
            }
        });*/
    ...
    public void onBackPressed() {
        Intent a = new Intent(ZiarahContentActivity.this, ZiarahActivity.class);
        startActivity(a);
        finish();
    }
}
